      ...
      <div ref={this.props.setWrapperRef} id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="about" className={`${this.props.article === 'about' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          {/*</p></Col></Row>*/}
            ...
            <table align="center">
                <tr>
                    <th align={"center"}>  Neha Mittal</th>
                    <th align={"cente"}> Mahmoud Hamsho</th>
                </tr>
                <tr>
                    <td> <span className=""><img src={pic03} width={130} height={180} alt="Desi Girl" /></span></td>
                    <td> <span className=""><img src={pic02} width={160} height={150} alt="Hamsho" /></span></td>

                </tr>

                <td><p>Neha Mittal</p><p> Product and Strategy Lead</p>
                ...
                <td><p>Mahmoud Hamsho</p><p> Tech and Design Lead</p>
